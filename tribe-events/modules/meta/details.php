...
<div class="tribe-events-meta-group tribe-events-meta-group-details small-12 large-4 columns">
	...
	<dl>
		...
		if ( tribe_event_is_all_day() && tribe_event_is_multiday() ) :
			...
			<dd>
				<abbr class="tribe-events-abbr published dtstart" title="<?php esc_attr_e( $start_ts ) ?>"> <?php esc_html_e( $start_date ) ?> </abbr>
			</dd>
		...
		elseif ( tribe_event_is_multiday() ) :
			...
			<dt> <?php esc_html_e( 'Start:', 'the-events-calendar' ) ?> </dt>
			<dd>
				<abbr class="tribe-events-abbr published dtstart" title="<?php esc_attr_e( $start_ts ) ?>"> <?php esc_html_e( $start_datetime ) ?> </abbr>
			</dd>
		...
		// Single day events
			...
			<dd><abbr class="tribe-events-abbr published dtstart" title="<?php esc_attr_e( $end_ts ) ?>">
